...
Z(z[8])
Z([3,'listItem'])
Z([[2,'+'],[[2,'+'],[[2,'+'],[1,'width:'],[1,'400upx']],[1,';']],[[2,'+'],[[2,'+'],[1,'font-size:'],[1,'16px']],[1,';']]])
Z([a,[[6],[[7],[3,'item']],[3,'title']]])
Z([3,'测试'])
Z([[6],[[7],[3,'item']],[3,'image']])
Z([[2,'+'],[[2,'+'],[[2,'+'],[1,'width:'],[1,'250upx']],[1,';']],[[2,'+'],[[2,'+'],[1,'height:'],[1,'100%']],[1,';']]])
Z(z[1])
Z([3,'15'])
Z([3,'arrowright'])
Z([[2,'+'],[1,'2-'],[[7],[3,'index']]])
...
var x=['./components/uni-icons/uni-icons.wxml','./components/wuc-tab/wuc-tab.wxml','./pages/index/index.wxml','./pages/login/login.wxml'];d_[x[0]]={}
...
var z=gz$gwx_2()
var fE=_mz(z,'scroll-view',['scrollWithAnimation',-1,'scrollX',-1,'class',0,'scrollLeft',1,'style',1],[],e,s,gg)
var cF=_v()
_(fE,cF)
...
var bO=_mz(z,'view',['bindtap',9,'class',1,'data-event-opts',2,'id',3],[],aL,lK,gg)
var oP=_n('text')
_rz(z,oP,'class',13,aL,lK,gg)
_(bO,oP)
var xQ=_n('label')
_rz(z,xQ,'class',14,aL,lK,gg)
var oR=_oz(z,15,aL,lK,gg)
_(xQ,oR)
_(bO,xQ)
_(tM,bO)
return tM
...
cI.wxXCkey=2
_2z(z,7,oJ,e,s,gg,cI,'item','index','index')
_(cF,oH)
}
var hG=_v()
_(fE,hG)
...
var aZ=_mz(z,'view',['bindtap',22,'class',1,'data-event-opts',2,'id',3],[],cW,oV,gg)
var t1=_n('text')
_rz(z,t1,'class',26,cW,oV,gg)
_(aZ,t1)
var e2=_n('label')
_rz(z,e2,'class',27,cW,oV,gg)
var b3=_oz(z,28,cW,oV,gg)
_(e2,b3)
_(aZ,e2)
_(oX,aZ)
return oX
...
var o6=_mz(z,'wuc-tab',['bind:__l',1,'bind:change',1,'bind:updateTabCur',2,'data-event-opts',3,'tabList',4,'tabCur',5,'vueId',6],[],e,s,gg)
_(x5,o6)
var f7=_v()
_(x5,f7)
var c8=function(o0,h9,cAB,gg){
var lCB=_n('view')
_rz(z,lCB,'class',12,o0,h9,gg)
var aDB=_n('view')
_rz(z,aDB,'style',13,o0,h9,gg)
var tEB=_n('view')
var eFB=_oz(z,14,o0,h9,gg)
_(tEB,eFB)
_(aDB,tEB)
var bGB=_n('view')
var oHB=_oz(z,15,o0,h9,gg)
_(bGB,oHB)
_(aDB,bGB)
_(lCB,aDB)
var xIB=_mz(z,'image',['src',16,'style',1],[],o0,h9,gg)
_(lCB,xIB)
var oJB=_mz(z,'uni-icons',['bind:__l',18,'size',1,'type',2,'vueId',3],[],o0,h9,gg)
_(lCB,oJB)
_(cAB,lCB)
return cAB
}
...
__wxAppCode__['pages/index/index.wxss']=setCssToHead([".",[1],"listItem{ display:-webkit-box; display:-webkit-flex; display:flex; -webkit-box-orient:vertical; -webkit-box-direction:normal; -webkit-flex-direction:cloum; flex-direction:cloum; width:100%; height:",[0,200],"; border-bottom:1px solid #e8e8e8; padding:",[0,20]," ",[0,20],"; -webkit-box-pack:justify; -webkit-justify-content:space-between; justify-content:space-between; -webkit-box-align:center; -webkit-align-items:center; align-items:center; box-sizing: border-box; }\n",],undefined,{path:"./pages/index/index.wxss"});    
